...
SL_per =10
Frame_level= '15m'
log_to_file_path = "5UP_filter_"+Frame_level+"_first_lony_top10.log"
golobal_data ="db_file/json/golobal_data_"+Frame_level+"_first_lony_top10"


#速度配置
POLL_INTERVAL_IN_SEC =60*7.5
SCAN_NEW_ARTI_INTERVAL_IN_SEC =60*5
PROXY_ERRO_INTERVAL_IN_SEC =60*1
CHOSE_RANGE=10#5.28 15:41 修改 50 改成 25

DealMgr = DEALMGR('db_file/sqlite/trade_list_30m_sqlite3__first_lony_top10.db')
